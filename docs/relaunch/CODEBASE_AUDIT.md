...
- No concrete self-host instructions for your target deployment-host + Cloudflare Tunnel setup.
...
### Current readiness for deployment-host self-hosting
...
For likely target app.example.com behind existing tunnel:
...
3. Serve static assets with Caddy or Nginx on deployment-host.
...
| 5 | deploy-selfhost-deployment-host | Add operational deployment artifacts/docs | New deploy docs/scripts and server configs | One-command or clearly documented deployment path | Medium |
