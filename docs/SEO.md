...
| `VITE_CANONICAL_URL` | Canonical/OG/JSON-LD URL, no trailing slash | `http://localhost:5174` | `https://app.example.com` |
...
```bash
cd web
VITE_INDEXABLE=true VITE_CANONICAL_URL=https://app.example.com npm run build
