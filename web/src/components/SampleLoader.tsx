...
const sampleFiles: SampleFile[] = [
  {
    ...
    filename: 'sales.csv',
    description:
      'E-commerce sales transactions with products, regions, and financial data',
    size: '8.2KB',
    rows: 60,
    columns: 8,
    features: [
  ...
  },
  {
    ...
    description:
      'Company expense tracking with categories, vendors, and payment methods',
    size: '6.8KB',
    rows: 50,
    columns: 10,
    features: [
  ...
  },
  {
    ...
    description:
      'Personal workout data with exercise types, duration, and health metrics',
    size: '9.1KB',
    rows: 50,
    columns: 12,
    features: [
  ...
  },
  {
    ...
    description:
      'Website traffic data with page views, user behavior, and conversion metrics',
    size: '12.3KB',
    rows: 50,
    columns: 15,
    features: [
