...
import { ChartConfig, generateChartData, getDefaultChartOptions } from '../utils/chartUtils'
 ...
 */
export const Chart: React.FC<ChartProps> = ({ dataset, config, className = '' }) => {
    ...
    return (
      <div className={`flex items-center justify-center h-64 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 ${className}`}>
        <div className="text-center text-gray-500">
          ...
          <p className="mt-2 text-sm">Unable to generate chart with current configuration</p>
        </div>
      </div>
    )
  }
