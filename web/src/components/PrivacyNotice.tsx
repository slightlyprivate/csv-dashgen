          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        All CSV parsing, data analysis, and chart generation
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Your data is never uploaded to external servers without
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        You can choose to save datasets locally for future
                        sessions. This is completely optional.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
              ...
              <div className="text-xs text-yellow-700 dark:text-yellow-300 space-y-1">
                <p>
                  • Browser storage may be cleared when you clear browser data
                </p>
                <p>
                  • Large datasets are processed in memory and may affect
                  browser performance
                </p>
                <p>
                  • You can delete all stored data at any time through the
                  settings
                </p>
                <p>
                  • No personal information is collected unless you explicitly
                  provide it
                </p>
              </div>
            </div>
